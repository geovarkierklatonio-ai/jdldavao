...
export const Home: React.FC = () => {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-900 via-red-900 to-red-800">
        {/* Animated background circles */}
        <div className="absolute inset-0 overflow-hidden">
          <motion.div
            animate={{ scale: [1, 1.2, 1], rotate: [0, 90, 180] }}
            transition={{ duration: 20, repeat: Infinity }}
            className="absolute -top-40 -right-40 w-80 h-80 bg-red-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20"
          />
          <motion.div
            animate={{ scale: [1, 1.1, 1], rotate: [180, 90, 0] }}
            transition={{ duration: 25, repeat: Infinity, delay: 2 }}
            className="absolute -bottom-40 -left-40 w-80 h-80 bg-red-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20"
          />
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 text-center">
          ...
          >
            ...
            <h1 className="text-6xl md:text-7xl font-bold text-white mb-6 leading-tight">
              Your Partner in <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-300 to-red-200">Security</span>
            </h1>
            ...
            <div className="flex flex-col md:flex-row gap-4 justify-center mb-12">
              <Link
                to="/contact"
                className="bg-gradient-to-r from-red-500 to-red-600 text-white px-8 py-4 rounded-lg font-bold text-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 flex items-center justify-center gap-2"
              >
            ...
            {stats.map((stat, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-gradient-to-br from-red-50 to-white p-8 rounded-xl text-center border border-red-200 hover:shadow-lg transition-shadow"
                >
                  <motion.div
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="bg-white/10 backdrop-blur-md rounded-2xl p-1 border border-white/20">
                <div className="bg-gradient-to-br from-red-300 to-red-400 rounded-xl aspect-square flex items-center justify-center">
                  <motion.div
      ...
      <section className="py-20 bg-gray-900 text-white">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            <Link
              to="/contact"
              className="bg-gradient-to-r from-red-500 to-red-600 px-8 py-4 rounded-lg font-bold text-lg hover:shadow-2xl hover:scale-105 transition-all duration-300"
            >
